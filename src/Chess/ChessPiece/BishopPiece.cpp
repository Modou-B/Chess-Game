...
BishopPiece::BishopPiece(int player, ChessPieceMovementGenerator *chessPieceMovementGenerator): BaseChessPiece(ChessConstants::BISHOP_PIECE_TYPE, player, chessPieceMovementGenerator) {}

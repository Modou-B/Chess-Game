...
void ServerWorker::setUserIdentifier(string userIdentifier)
{
    this->userIdentifier = userIdentifier;
}

void ServerWorker::setInMatchStatus(bool isInMatch) {
    this->isInMatch = isInMatch;
}

void ServerWorker::setOpponentIdentifier(string opponentIdentifier) {
...
string ServerWorker::getUserIdentifier() {
